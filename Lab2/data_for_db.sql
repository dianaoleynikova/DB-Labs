...
('9780143127796', '1984', 1949, 'Dystopian', 1),
('9780061120084', 'To Kill a Mockingbird', 1960, 'Fiction', 2);
...
INSERT INTO Copy (book_id, condition, is_available) VALUES
(1, 'Good', TRUE),
(1, 'Worn', FALSE),
(2, 'Excellent', TRUE);
...
(2, 1, '2025-11-01', '2025-11-08', '2025-11-07', 0.00),
(3, 2, '2025-11-03', '2025-11-10', NULL, 2.50);
